...
class TodoList
  ...
  def find_by_title(str)
    # takes string as argument and returns first Todo object matching arg
    # returns nil if no todo is found
  ...
  def mark_done(str)
    # takes a string as arg, marks first Todo object matching arg as done
    select { |todo| todo.title == str }.done!
  end
